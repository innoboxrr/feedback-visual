export function DoEntireFormat(event, eventType, input, rawInput, pattern, mask) { 
...
export function format(elem, eventType, event) {

    var result = DoEntireFormat(event, eventType, elem, elem.value, elem.getAttribute('data-format'), elem.getAttribute('data-mask'));    
